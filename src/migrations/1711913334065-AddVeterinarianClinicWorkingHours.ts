...
export class AddVeterinarianClinicWorkingHours1711913334065 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "working_hours" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "dayOfWeek" integer NOT NULL, "openingTime" character varying NOT NULL, "closingTime" character varying NOT NULL, "specialNotes" character varying NOT NULL, "clinicId" uuid, CONSTRAINT "PK_5f84d2fa3953367fe9d704d8df6" PRIMARY KEY ("id"))`);
