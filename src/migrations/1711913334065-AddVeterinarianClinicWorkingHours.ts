...
export class AddVeterinarianClinicWorkingHours1711913334065 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "veterinarian" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phoneNumber" character varying NOT NULL, "photo" bytea, "userId" uuid, "clinicId" uuid, CONSTRAINT "REL_621ed83931efcb5bf706ae8927" UNIQUE ("userId"), CONSTRAINT "PK_f747fb2870fc56cd0f030cbea71" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "working_hours" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "dayOfWeek" integer NOT NULL, "openingTime" TIME NOT NULL, "closingTime" TIME NOT NULL, "specialNotes" character varying NOT NULL, "clinicId" uuid, CONSTRAINT "PK_5f84d2fa3953367fe9d704d8df6" PRIMARY KEY ("id"))`);
